...
- ✅ **Mise en place de Nifi Registry** : Déploiement et configuration pour la gestion de versions des flows
...
✅ **Mise en place d'Apache Nifi et Nifi Registry**
- Déploiement de Nifi sur Kubernetes (cluster HA)
- Déploiement de Nifi Registry pour la gestion de versions des flows
- Configuration des processors et flows de base
- Intégration Nifi avec Nifi Registry
...
### Jour 2-3 : Mise en place d'Apache Nifi et Nifi Registry
...
3. **Déploiement de Nifi Registry**
   - Déploiement de Nifi Registry sur Kubernetes
   - Configuration de la base de données (PostgreSQL ou H2)
   - Configuration du stockage pour les buckets de flows
   - Configuration de la sécurité (authentification, autorisation)

4. **Intégration Nifi avec Nifi Registry**
   - Configuration de la connexion Nifi → Nifi Registry
   - Configuration des buckets et projets dans Registry
   - Mise en place du workflow de versioning des flows
...
5. **Configuration et intégration**
   ...
   - Versioning des flows dans Nifi Registry
...
6. **Tests et validation**
   ...
   - Tests de versioning dans Nifi Registry
   - Tests de performance et scalabilité
   - Validation de la haute disponibilité
   - Tests de récupération après panne
   - Tests de déploiement de flows depuis Registry

**Livrables** :
- Apache Nifi opérationnel en cluster HA
- Nifi Registry opérationnel et intégré
- Manifests Kubernetes / Helm charts pour Nifi et Nifi Registry
- Configuration ZooKeeper
- Configuration de l'intégration Nifi ↔ Nifi Registry
- Exemples de flows Nifi documentés et versionnés
- Documentation de configuration et d'utilisation
- Guide de gestion des versions avec Nifi Registry
...
| **Mardi** | Mise en place Apache Nifi et Nifi Registry (Partie 1) | 1 JH | ✅ Obligatoire |
| **Mercredi** | Mise en place Apache Nifi et Nifi Registry (Partie 2) | 1 JH | ✅ Obligatoire |
...
2. ✅ **Priorité 2** : Mise en place Nifi et Nifi Registry (Jours 2-3)
3. ⭐ **Priorité 3** : Airflow (Jour 4) - si temps disponible
4. ⭐ **Priorité 4** : Trino (Jour 5) - si temps disponible

**Note** : Les composants "Nice to have" seront déployés selon le temps disponible. Si le déploiement de Nifi et Nifi Registry prend plus de temps que prévu, Airflow et Trino pourront être reportés à une phase ultérieure.
...
| Jours 2-3 | Mise en place Apache Nifi et Nifi Registry | 2 | Forfait |
...
| Jours 2-3 | Mise en place Apache Nifi et Nifi Registry | 2 | 350 000 FCFA | 700 000 FCFA |
...
### Jours 2-3 : Apache Nifi et Nifi Registry
...
- ✅ **Nifi Registry opérationnel**
  - Déploiement sur Kubernetes
  - Configuration de la base de données
  - Intégration avec Nifi
  - Buckets et projets configurés

- ✅ **Manifests Kubernetes / Helm charts**
  - Configuration complète pour déploiement Nifi
  - Configuration complète pour déploiement Nifi Registry
  - Documentation de déploiement

- ✅ **Documentation technique**
  - Guide de configuration Nifi
  - Guide de configuration Nifi Registry
  - Guide d'intégration Nifi ↔ Nifi Registry
  - Guide d'utilisation et de gestion des versions
  - Exemples de flows documentés et versionnés
  - Guide de bonnes pratiques
...
1. **Complexité du déploiement Nifi et Nifi Registry**
...
- Expérience confirmée sur Apache Nifi, Nifi Registry, Airflow, Trino, Iceberg
